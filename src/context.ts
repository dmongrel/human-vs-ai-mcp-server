...
- Em dash overuse: frequency of the "—" character, a widely reported LLM stylistic tic (notably ChatGPT). Also counts the en dash "–" when flanked by spaces, since some models reach for " – " where others use "—" and the tell is the same; unspaced en dashes are left alone, because that form is ordinary number-range typography ("1914–18") rather than a stylistic tic.
